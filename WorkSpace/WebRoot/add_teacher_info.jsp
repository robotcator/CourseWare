...
<html>
  ...
  <body>
	...
	<form name="student_form" method="post" action="add_teacher_save.jsp" >
	
	<table width="90%" style="center">
	<tr>
		<td width="20%"height="30" align="right">教师编号:</td>
		<td width="30%"height="30" align="left">&nbsp;<input type="text" name="TeacherID" size="20"></td>
	</tr>
	<tr>
		<td width="20%"height="30" align="right">&nbsp;教师姓名:</td>
		<td width="30%"height="30" align="left">&nbsp;<input type="text" name="TeacherName" size="20"></td>
	</tr>
	<tr>	
	...
	<tr>	
		<td width="20%"height="30" align="right">&nbsp;教师院系:</td>
		<td width="30%"height="30" align="left">&nbsp;<input type="text" name="Department" size="20"></td>
	</tr>
	</table>
	<p align="center">
